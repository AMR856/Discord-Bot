  ...
  async execute(interaction, _) {
    ...
    .setOptions([
      new SelectMenuOptionBuilder( {
        label: 'C',
        value: 'https://www.youtube.com/watch?v=EjavYOFoJJ0&list=PLdo5W4Nhv31a8UcMN9-35ghv8qyFWD9_S'
      }),
      new SelectMenuOptionBuilder( {
        label: 'Python',
        value: 'https://www.youtube.com/watch?v=mvZHDpCHphk&list=PLDoPjvoNmBAyE_gei5d18qkfIe-Z8mocs&pp=iAQB'
      }),
      new SelectMenuOptionBuilder( {
        label: 'JavaScript',
        value: 'https://www.youtube.com/watch?v=GM6dQBmc-Xg&list=PLDoPjvoNmBAx3kiplQR_oeDqLDBUDYwVv&pp=iAQB'
      })
    ]);
